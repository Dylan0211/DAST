...
def test_model(data_x, data_y, model_name, load_max, load_min, input_dim, hidden_dim, num_layers, batch_size, sparse_output_dim,
               output_dim, enc_hid_dim, dec_hid_dim):
    ...
    print('    model name: {}, CV-RMSE = {}'.format(model_name, cv_rmse(np.array(label_list), np.array(pred_list))))
