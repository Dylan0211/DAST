...
class Decoder(nn.Module):
    def __init__(self, attention, output_dim, enc_hid_dim, dec_hid_dim):
        super().__init__()
...
class Seq2Seq_with_attention(nn.Module):
    def __init__(self, input_dim, output_dim, enc_hid_dim, dec_hid_dim):
        super(Seq2Seq_with_attention, self).__init__()
        self.attention = Attention(enc_hid_dim, dec_hid_dim)
        self.encoder = Encoder(input_dim, enc_hid_dim, dec_hid_dim)
        self.decoder = Decoder(self.attention, output_dim, enc_hid_dim, dec_hid_dim)
